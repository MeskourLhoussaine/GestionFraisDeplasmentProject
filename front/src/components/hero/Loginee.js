...
export default function Loginee({isAuth, setAuth}) {
    ...
    const onSubmit = (e) => {
        ...
        try {
            accountService.login(username, password).then(async (res) => {
                const token = decodeToken(res.data.access_token);
                const user = await accountService.getUserByUsername(token.sub);
                console.log("roleS", user.roles);
                accountService.saveToken(res.data.access_token);
                accountService.saveRole(user.roles);
